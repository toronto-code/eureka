...
from mycelium_api.supabase_client import SupabaseUser, get_supabase_user, service_client
...
async def _build_live_context() -> str:
    ...
    try:
        from mycelium_api.routers.chat_intel import fetch_github, fetch_slack, fetch_jira
